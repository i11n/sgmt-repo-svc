/**
 * This file exports the template for creating a CONTRIBUTING.md file.
 *
...
Thank you for your interest in contributing to the sgmt libraries. There
...
If you find an issue in a sgmt libraries source code, you can help by
...
a sgmt library's GitHub Repository. If you are unsure which library a
feature should be requested in, you can [submit an issue][feature-new] on the
&grave;i11n/sgmt&grave; repo.
...
convention. The core sgmt libraries do not have any scopes.
...
[feature-new]: https://github.com/i11n/sgmt/issues/new?template=feature.yaml&title= "Request a new feature in sgmt"
[issues]: https://github.com/i11n/${'pkg.name'}/issues/new?template=issue.yaml&title= "Report an issue in i11n/${'pkg.name'}"
[feature]: https://github.com/i11n/${'pkg.name'}/issues/new?template=feature.md&title= "Request a new feature in i11n/${'pkg.name'}"
[documentation]: https://github.com/i11n/${'pkg.name'}/labels/type%3A%20docs "Documentation issues in i11n/${'pkg.name'}"
[first-issue]: https://github.com/i11n/${'pkg.name'}/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22 "Good first issues in i11n/${'pkg.name'}"
`;
